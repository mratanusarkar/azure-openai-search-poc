                ...
                "history": [
                    {
                        "user": random.choice(
                            [
                                "Summerize the proCCess library.",
                                "What are the test processes for Software Release?",
                                "Can you explain me the software development and build process?",
                                "How to write a project quality report?",
                            ]
                        )
                    }
                ],
